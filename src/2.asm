;В этой задаче вам потребуется написать ассемблерный код, который проверяет поместится ли сумма 
;двух заданных беззнаковых чисел в 32 битовый регистр. Числа поступают на вход в регистрах %eax и %edx. 
